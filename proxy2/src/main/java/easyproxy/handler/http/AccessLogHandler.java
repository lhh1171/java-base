package easyproxy.handler.http;/**
 * Description : 
...
import easyproxy.cache.Cache;
import easyproxy.constants.Const;
import easyproxy.log.Logger;
import easyproxy.selector.IPSelector;
import easyproxy.selector.manager.HostManager;

import java.net.InetSocketAddress;
import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

import static easyproxy.constants.Const.ACCESSRECORD;
